...
public class RoutePlanActivity extends Activity implements BaiduMap.OnMapClickListener,
  ...
  //  MassTransitRouteResult nowResultmass = null;
    ...
    private RoutePlanActivity.MyLocationListener myListener = new RoutePlanActivity.MyLocationListener();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNavi= (Button) findViewById(R.id.btnStartNavi);
        ...
        startNodeStr=intent.getStringExtra("start");
        endNodeStr=intent.getStringExtra("end");
    ...
    public void searchButtonProcess(View v) {
        ...
        if(startNodeStr.equals("我的位置")){
            stNode=PlanNode.withLocation(new LatLng(mCurrentLat,mCurrentLon));
        }else if(startNodeStr.equals("地图上的点")){
            stNode=PlanNode.withLocation(new LatLng(startLat,startLon));
        }

        if(endNodeStr.equals("我的位置")){
            enNode=PlanNode.withLocation(new LatLng(mCurrentLat,mCurrentLon));
